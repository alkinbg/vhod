...
final class Version20260907210000 extends AbstractMigration
{
    ...
    {
        return 'Extend the condominium book with legal entities, household history, absences and animal records.';
    }

    public function up(Schema $schema): void
    {
        $this->addSql('ALTER TABLE unit_relation DROP FOREIGN KEY FK_UNIT_RELATION_PERSON');
        $this->addSql('ALTER TABLE unit_relation MODIFY person_id INT DEFAULT NULL, ADD legal_entity_name VARCHAR(255) DEFAULT NULL, ADD legal_entity_identifier VARCHAR(64) DEFAULT NULL, ADD management_rights_and_obligations LONGTEXT DEFAULT NULL');
        ...
        $this->addSql('CREATE TABLE household_member (id INT AUTO_INCREMENT NOT NULL, person_id INT NOT NULL, relation_id INT NOT NULL, valid_from DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', valid_until DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', INDEX IDX_HOUSEHOLD_MEMBER_PERSON (person_id), INDEX IDX_HOUSEHOLD_MEMBER_RELATION (relation_id), INDEX idx_household_member_period (valid_from, valid_until), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE unit_absence (id INT AUTO_INCREMENT NOT NULL, person_id INT NOT NULL, unit_id INT NOT NULL, valid_from DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', valid_until DATE DEFAULT NULL COMMENT \'(DC2Type:date_immutable)\', INDEX IDX_UNIT_ABSENCE_PERSON (person_id), INDEX IDX_UNIT_ABSENCE_UNIT (unit_id), INDEX idx_unit_absence_period (valid_from, valid_until), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE unit_relation DROP FOREIGN KEY FK_UNIT_RELATION_PERSON');
        $this->addSql('ALTER TABLE unit_relation DROP legal_entity_name, DROP legal_entity_identifier, DROP management_rights_and_obligations, MODIFY person_id INT NOT NULL');
        $this->addSql('ALTER TABLE unit_relation ADD CONSTRAINT FK_UNIT_RELATION_PERSON FOREIGN KEY (person_id) REFERENCES person (id) ON DELETE CASCADE');
    }
}
