...
final class Version20260908110000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql("CREATE TABLE bank_counterparty_mapping (id INT AUTO_INCREMENT NOT NULL, unit_id INT NOT NULL, counterparty_iban VARCHAR(34) NOT NULL, active TINYINT(1) DEFAULT NULL, created_at DATETIME NOT NULL, UNIQUE INDEX uniq_bank_counterparty_mapping_active_iban (counterparty_iban, active), INDEX idx_bank_counterparty_mapping_lookup (counterparty_iban, active), INDEX idx_bank_counterparty_mapping_unit (unit_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB");
