...
final class Version20260908130000 extends AbstractMigration
{
    ...
    {
        $this->addSql('CREATE TABLE expense (id INT AUTO_INCREMENT NOT NULL, fund_id INT NOT NULL, category VARCHAR(255) NOT NULL, amount_cents INT NOT NULL, paid_at DATETIME NOT NULL, posted_at DATETIME NOT NULL, description VARCHAR(255) NOT NULL, payee VARCHAR(255) DEFAULT NULL, document_reference VARCHAR(190) DEFAULT NULL, note LONGTEXT DEFAULT NULL, INDEX IDX_2D3A8DA625A38F89 (fund_id), INDEX idx_expense_paid_at (paid_at), INDEX idx_expense_fund_paid (fund_id, paid_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE external_income (id INT AUTO_INCREMENT NOT NULL, fund_id INT NOT NULL, category VARCHAR(255) NOT NULL, amount_cents INT NOT NULL, received_at DATETIME NOT NULL, posted_at DATETIME NOT NULL, description VARCHAR(255) NOT NULL, document_reference VARCHAR(190) DEFAULT NULL, note LONGTEXT DEFAULT NULL, INDEX IDX_4B2BFD3925A38F89 (fund_id), INDEX idx_external_income_received_at (received_at), INDEX idx_external_income_fund_received (fund_id, received_at), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
