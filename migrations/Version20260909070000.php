...
final class Version20260909070000 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        // Doctrine ORM 3.7 does not expose custom index metadata for ManyToMany join tables.
        // Keep the generated inverse-FK index name so schema validation stays exactly in sync.
        $this->addSql("CREATE TABLE official_announcement_document (announcement_id INT NOT NULL, document_id INT NOT NULL, INDEX IDX_917CE1D5C33F7837 (document_id), PRIMARY KEY (announcement_id, document_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB");
