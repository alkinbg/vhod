...
final class Version20260909150000 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE assembly_invitation_posting DROP FOREIGN KEY fk_invitation_posting_assembly');
        ...
        $this->addSql('DROP TABLE assembly_invitation_posting');
